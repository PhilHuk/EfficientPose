...
def main():
    ...
    #input parameter
    phi = 0
    path_to_weights = "/home/phil/Code/EfficientPose/checkpoints/weights_412.h5"          # "./weights/phi_0_occlusion_best_ADD(-S).h5"
    # save_path = "./predictions/occlusion/" #where to save the images or None if the images should be displayed and not saved
    save_path = None
    image_extension = ".jpg"
    class_to_name = {0: "pyramide", 1: "platte", 2: "wuerfel", 3: "adapter", 4: "kugel"}      #{0: "ape", 1: "can", 2: "cat", 3: "driller", 4: "duck", 5: "eggbox", 6: "glue", 7: "holepuncher"} #Occlusion
...
def get_linemod_camera_matrix():
    ...
    return np.array([[500, 0., 330], [0., 500, 250], [0., 0., 1.]], dtype = np.float32)       # logitech c310
...
def get_linemod_3d_bboxes():
    ...
    """
    name_to_model_info = {
                            'platte':       {'diameter': 169.0739, 'min_x': -67.5, 'min_y': -50.0, 'min_z': -1.0, 'size_x': 135.0, 'size_y': 100.0, 'size_z': 19.0},
