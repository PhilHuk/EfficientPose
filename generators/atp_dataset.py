...
class OcclusionGenerator(Generator):    # keep name 'occlusionGenerator'
    """
    Generator for own dataset (similar to occlusion -> multiple objects)

    """
    def __init__(self,
                 dataset_base_path,
                 object_ids = {"pyramide": 1, "platte": 2, "wuerfel": 3, "adapter":4, "kugel":5}, #dictionary with the names and object ids of the dataset # TODO
                 image_extension = ".png",
                 shuffle_dataset = True,
                  symmetric_objects = {"platte", 2, "wuerfel", 3, "adapter", 4, "kugel", 5}, #set with names and indices of symmetric objects
                 **kwargs):
        """
        ...
        self.class_to_name = {0: "pyramide", 1: "platte", 2: "wuerfel", 3: "adapter", 4: "kugel"}          # TODO
        ...
        self.name_to_mask_value = {"pyramide": 204,   # TODO
                                   "platte": 153,
                                   "wuerfel": 255,
                                   "adapter": 51,
                                   "kugel": 102}
