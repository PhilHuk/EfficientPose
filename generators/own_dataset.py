...
class OcclusionGenerator(Generator):    # keep name 'occlusionGenerator'
    ...
    def __init__(self,
                 dataset_base_path,
                 object_ids = {"bottom": 1, "top": 2}, #dictionary with the names and object ids of the dataset # TODO
                 image_extension = ".png",
        ...
        self.class_to_name = {0: "bottom", 1: "top"}          # TODO
        ...
        self.name_to_mask_value = {"bottom": 127,   # TODO
                                   "top": 254}
